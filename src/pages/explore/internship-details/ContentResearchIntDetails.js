...
function ContentResearchIntDetails({ navigation }) {
      ...
      <View style={{ paddingHorizontal: 10, paddingBottom: 50 }}>
        ...
        >
          ...
          <View style={{ width: "75%", marginTop: 20 }}>
            ...
            >
              Content research & writing intern
            </Text>
          </View>
        </View>
        <Text
        ...
        <View style={styles.row}>
          ...
          <View style={styles.details}>
            ...
            <Button
              ...
              w="50%"
              size="xs"
              onPress={() => navigation.navigate("internship-form")}
            >
...
export default ContentResearchIntDetails;
